...
abstract class PluginsfGuardUser extends BasesfGuardUser
{
  ...
  public function setPassword($password)
  {
    ...
    /*
    * si la valeur du salt est définie , alors le mot de passe est probablement crypté
    * dans ce cas on appele la fonction setPassword sans  user_funx algorythm pour crptage
    */
    $fromdump = false;
    ...
    /*
    * si le mot de passe est déjà crypté, alors on ne le fait plus
    */
    if($fromdump){
