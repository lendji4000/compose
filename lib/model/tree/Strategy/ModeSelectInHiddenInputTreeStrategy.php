...
class ModeSelectInHiddenInputTreeStrategy implements ITreeStrategy
{
    ...
    public function render(ITree $tree, array $options, $key)
    {
        ...
        return html_entity_decode(sfOutputEscaper::unescape(get_component("eitreeviewer", "displaySelectInHiddenInputMode", array(
            "root" => $tree,
    ...
    public function importAssets()
    {
        ...
        use_javascript("treeManagement/jstree/selectInHiddenInputMode/selectInHiddenInputMode.js");
