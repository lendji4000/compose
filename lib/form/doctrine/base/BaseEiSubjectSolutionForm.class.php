...
/**
 * EiSubjectSolution form base class.
 *
 * @method EiSubjectSolution getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseEiSubjectSolutionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_subject_solution[%s]');
