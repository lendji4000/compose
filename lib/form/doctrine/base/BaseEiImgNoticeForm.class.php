...
/**
 * EiImgNotice form base class.
 *
 * @method EiImgNotice getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseEiImgNoticeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_img_notice[%s]');
