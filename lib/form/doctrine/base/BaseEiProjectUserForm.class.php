...
/**
 * EiProjectUser form base class.
 *
 * @method EiProjectUser getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseEiProjectUserForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_project_user[%s]');
