...
/**
 * EiProfileParam form base class.
 *
 * @method EiProfileParam getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseEiProfileParamForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_profile_param[%s]');
