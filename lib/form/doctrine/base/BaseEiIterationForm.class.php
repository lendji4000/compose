...
/**
 * EiIteration form base class.
 *
 * @method EiIteration getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseEiIterationForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id'          => new sfWidgetFormInputHidden(),
      'delivery_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('EiDelivery'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'delivery_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('EiDelivery'))),
    ...
    $this->widgetSchema->setNameFormat('ei_iteration[%s]');
