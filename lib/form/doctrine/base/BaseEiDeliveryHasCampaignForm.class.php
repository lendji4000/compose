...
/**
 * EiDeliveryHasCampaign form base class.
 *
 * @method EiDeliveryHasCampaign getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseEiDeliveryHasCampaignForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_delivery_has_campaign[%s]');
