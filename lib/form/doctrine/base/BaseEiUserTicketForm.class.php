...
/**
 * EiUserTicket form base class.
 *
 * @method EiUserTicket getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseEiUserTicketForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_user_ticket[%s]');
