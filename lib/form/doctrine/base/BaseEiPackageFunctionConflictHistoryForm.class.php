...
/**
 * EiPackageFunctionConflictHistory form base class.
 *
 * @method EiPackageFunctionConflictHistory getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseEiPackageFunctionConflictHistoryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_package_function_conflict_history[%s]');
  ...
  {
    return 'EiPackageFunctionConflictHistory';
  }
