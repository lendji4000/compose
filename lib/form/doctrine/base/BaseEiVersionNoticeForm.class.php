...
/**
 * EiVersionNotice form base class.
 *
 * @method EiVersionNotice getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseEiVersionNoticeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_version_notice[%s]');
