...
/**
 * ScriptEiScript form base class.
 *
 * @method ScriptEiScript getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseScriptEiScriptForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('script_ei_script[%s]');
