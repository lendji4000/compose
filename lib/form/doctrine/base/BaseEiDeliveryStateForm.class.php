...
/**
 * EiDeliveryState form base class.
 *
 * @method EiDeliveryState getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseEiDeliveryStateForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'close_state'          => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'close_state'          => new sfValidatorBoolean(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ei_delivery_state[%s]');
