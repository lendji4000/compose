...
/**
 * EiFunctionHasPack form base class.
 *
 * @method EiFunctionHasPack getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseEiFunctionHasPackForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_function_has_pack[%s]');
