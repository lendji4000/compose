...
/**
 * ScriptEiFunctionHasCommande form base class.
 *
 * @method ScriptEiFunctionHasCommande getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseScriptEiFunctionHasCommandeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('script_ei_function_has_commande[%s]');
