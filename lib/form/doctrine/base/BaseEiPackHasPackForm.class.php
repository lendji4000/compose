...
/**
 * EiPackHasPack form base class.
 *
 * @method EiPackHasPack getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseEiPackHasPackForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_pack_has_pack[%s]');
