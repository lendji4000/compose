...
/**
 * ScriptEiNoticeProfil form base class.
 *
 * @method ScriptEiNoticeProfil getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseScriptEiNoticeProfilForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('script_ei_notice_profil[%s]');
