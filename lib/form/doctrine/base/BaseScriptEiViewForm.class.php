...
/**
 * ScriptEiView form base class.
 *
 * @method ScriptEiView getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseScriptEiViewForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('script_ei_view[%s]');
