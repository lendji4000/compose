...
/**
 * ScriptEiScriptVersion form base class.
 *
 * @method ScriptEiScriptVersion getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseScriptEiScriptVersionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('script_ei_script_version[%s]');
