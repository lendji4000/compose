...
/**
 * EiFunctionHasParam form base class.
 *
 * @method EiFunctionHasParam getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseEiFunctionHasParamForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_function_has_param[%s]');
