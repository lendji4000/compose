...
/**
 * ScriptEiEnvironnementProjet form base class.
 *
 * @method ScriptEiEnvironnementProjet getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseScriptEiEnvironnementProjetForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('script_ei_environnement_projet[%s]');
