...
/**
 * ScriptEiProfil form base class.
 *
 * @method ScriptEiProfil getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseScriptEiProfilForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('script_ei_profil[%s]');
