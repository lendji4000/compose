...
/**
 * ScriptEiPackOfFunction form base class.
 *
 * @method ScriptEiPackOfFunction getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseScriptEiPackOfFunctionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('script_ei_pack_of_function[%s]');
