...
/**
 * ScriptEiTicket form base class.
 *
 * @method ScriptEiTicket getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseScriptEiTicketForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('script_ei_ticket[%s]');
