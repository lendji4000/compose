...
/**
 * EiSubjectState form base class.
 *
 * @method EiSubjectState getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseEiSubjectStateForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'close_del_state'      => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'close_del_state'      => new sfValidatorBoolean(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ei_subject_state[%s]');
