...
/**
 * EiProjectLang form base class.
 *
 * @method EiProjectLang getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseEiProjectLangForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_project_lang[%s]');
