...
/**
 * EiTaskStateHistory form base class.
 *
 * @method EiTaskStateHistory getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseEiTaskStateHistoryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_task_state_history[%s]');
