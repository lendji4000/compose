...
/**
 * ScriptEiNotice form base class.
 *
 * @method ScriptEiNotice getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseScriptEiNoticeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('script_ei_notice[%s]');
