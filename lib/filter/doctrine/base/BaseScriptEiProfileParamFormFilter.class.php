...
/**
 * ScriptEiProfileParam filter form base class.
 *
 ...
 */
abstract class BaseScriptEiProfileParamFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('script_ei_profile_param_filters[%s]');
