...
/**
 * EiEnvironnementProjet filter form base class.
 *
 ...
 */
abstract class BaseEiEnvironnementProjetFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_environnement_projet_filters[%s]');
