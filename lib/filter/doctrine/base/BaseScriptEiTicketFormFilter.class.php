...
/**
 * ScriptEiTicket filter form base class.
 *
 ...
 */
abstract class BaseScriptEiTicketFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('script_ei_ticket_filters[%s]');
