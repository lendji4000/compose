...
/**
 * EiFunctionHasCommande filter form base class.
 *
 ...
 */
abstract class BaseEiFunctionHasCommandeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_function_has_commande_filters[%s]');
