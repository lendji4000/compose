...
/**
 * EiUserTicket filter form base class.
 *
 ...
 */
abstract class BaseEiUserTicketFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_user_ticket_filters[%s]');
