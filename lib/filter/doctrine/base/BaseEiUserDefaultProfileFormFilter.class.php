...
/**
 * EiUserDefaultProfile filter form base class.
 *
 ...
 */
abstract class BaseEiUserDefaultProfileFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_user_default_profile_filters[%s]');
