...
/**
 * EiSubjectDetails filter form base class.
 *
 ...
 */
abstract class BaseEiSubjectDetailsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_subject_details_filters[%s]');
