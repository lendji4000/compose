...
/**
 * EiFonction filter form base class.
 *
 ...
 */
abstract class BaseEiFonctionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_fonction_filters[%s]');
