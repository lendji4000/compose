...
/**
 * EiActiveIteration filter form base class.
 *
 ...
 */
abstract class BaseEiActiveIterationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_active_iteration_filters[%s]');
