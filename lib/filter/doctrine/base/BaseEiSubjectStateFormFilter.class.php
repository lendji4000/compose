...
/**
 * EiSubjectState filter form base class.
 *
 ...
 */
abstract class BaseEiSubjectStateFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'display_in_todolist'  => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'close_del_state'      => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'display_in_todolist'  => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'close_del_state'      => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
    ...
    $this->widgetSchema->setNameFormat('ei_subject_state_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      ...
      'display_in_todolist'  => 'Boolean',
      'close_del_state'      => 'Boolean',
      'project_id'           => 'Number',
      'project_ref'          => 'Number',
      'created_at'           => 'Date',
      'updated_at'           => 'Date',
