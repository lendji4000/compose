...
/**
 * EiSubjectPriority filter form base class.
 *
 ...
 */
abstract class BaseEiSubjectPriorityFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_subject_priority_filters[%s]');
