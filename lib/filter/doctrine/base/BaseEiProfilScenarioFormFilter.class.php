...
/**
 * EiProfilScenario filter form base class.
 *
 ...
 */
abstract class BaseEiProfilScenarioFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_profil_scenario_filters[%s]');
