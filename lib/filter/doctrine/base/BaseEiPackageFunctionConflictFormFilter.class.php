...
/**
 * EiPackageFunctionConflict filter form base class.
 *
 ...
 */
abstract class BaseEiPackageFunctionConflictFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_package_function_conflict_filters[%s]');
