...
/**
 * EiFlagScenario filter form base class.
 *
 ...
 */
abstract class BaseEiFlagScenarioFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_flag_scenario_filters[%s]');
