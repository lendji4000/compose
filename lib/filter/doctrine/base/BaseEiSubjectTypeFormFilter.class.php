...
/**
 * EiSubjectType filter form base class.
 *
 ...
 */
abstract class BaseEiSubjectTypeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_subject_type_filters[%s]');
