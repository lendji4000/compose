...
/**
 * EiScenarioPackage filter form base class.
 *
 ...
 */
abstract class BaseEiScenarioPackageFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_scenario_package_filters[%s]');
