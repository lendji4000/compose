...
/**
 * EiProfil filter form base class.
 *
 ...
 */
abstract class BaseEiProfilFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_profil_filters[%s]');
