...
/**
 * EiProjectUser filter form base class.
 *
 ...
 */
abstract class BaseEiProjectUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_project_user_filters[%s]');
