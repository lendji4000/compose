...
/**
 * EiSubjectMessageType filter form base class.
 *
 ...
 */
abstract class BaseEiSubjectMessageTypeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_subject_message_type_filters[%s]');
