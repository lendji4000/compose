...
/**
 * ScriptEiScriptVersion filter form base class.
 *
 ...
 */
abstract class BaseScriptEiScriptVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('script_ei_script_version_filters[%s]');
