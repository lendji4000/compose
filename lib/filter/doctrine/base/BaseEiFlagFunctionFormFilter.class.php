...
/**
 * EiFlagFunction filter form base class.
 *
 ...
 */
abstract class BaseEiFlagFunctionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_flag_function_filters[%s]');
