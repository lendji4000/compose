...
/**
 * EiScenarioExecutable filter form base class.
 *
 ...
 */
abstract class BaseEiScenarioExecutableFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_scenario_executable_filters[%s]');
