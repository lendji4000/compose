...
/**
 * EiTaskStateHistory filter form base class.
 *
 ...
 */
abstract class BaseEiTaskStateHistoryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_task_state_history_filters[%s]');
