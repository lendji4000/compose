...
/**
 * EiFlagDelivery filter form base class.
 *
 ...
 */
abstract class BaseEiFlagDeliveryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_flag_delivery_filters[%s]');
