...
/**
 * EiPackageFunctionConflictHistory filter form base class.
 *
 ...
 */
abstract class BaseEiPackageFunctionConflictHistoryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_package_function_conflict_history_filters[%s]');
