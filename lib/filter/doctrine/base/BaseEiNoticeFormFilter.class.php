...
/**
 * EiNotice filter form base class.
 *
 ...
 */
abstract class BaseEiNoticeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_notice_filters[%s]');
