...
/**
 * EiPackHasPack filter form base class.
 *
 ...
 */
abstract class BaseEiPackHasPackFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_pack_has_pack_filters[%s]');
