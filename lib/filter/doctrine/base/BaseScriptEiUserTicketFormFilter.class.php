...
/**
 * ScriptEiUserTicket filter form base class.
 *
 ...
 */
abstract class BaseScriptEiUserTicketFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('script_ei_user_ticket_filters[%s]');
