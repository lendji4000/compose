...
/**
 * EiImgNotice filter form base class.
 *
 ...
 */
abstract class BaseEiImgNoticeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_img_notice_filters[%s]');
