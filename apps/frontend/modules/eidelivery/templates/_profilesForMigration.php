<?php if (isset($ei_profiles) && isset($current_profile) && isset($ei_project)  ): ?>
  ...
  <div class="btn-group" role="group">
    ...
    <ul class="dropdown-menu">
            <?php foreach ($ei_profiles as $ei_profile): ?>
                <li>
                    <?php  echo link_to2(ei_icon('ei_profile') . ' ' . $ei_profile->getTroncatedName(20), 'changeProfileForMigrationDelivery',
