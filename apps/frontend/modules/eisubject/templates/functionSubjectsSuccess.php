...
<div class="row">
    ...
    <div class="col-lg-9 col-md-9" id="subjectsFunction"> 
...
<div class="row">  
        <?php $searchBox =$url_tab;  $searchBox['subjectSearchForm']=$subjectSearchForm ?>
            ...
            <?php $searchBox['contextRequest']=(isset($contextRequest)?$contextRequest:null) ?>
...
<!--                            <li> 
            ...
            <div class="panel panel-default eiPanel">
                ...
                <div class="panel-footer">
                    ...
                    <?php $pagerMenu=$url_tab ;$pagerMenu['current_page']=$current_page ?>
                    <?php $pagerMenu['nb_pages']=$nb_pages ?>
                    <?php $pagerMenu['nbEnr']=$nbEnr ?>
                    <?php $pagerMenu['offset']=$offset ?>
                    <?php $pagerMenu['max_subject_per_page']=$max_subject_per_page ?>
                    <?php $pagerMenu['searchSubjectCriteria']=$searchSubjectCriteria ?>
                    <?php $pagerMenu['contextRequest']=(isset($contextRequest)?$contextRequest:null) ?>
                    <?php $pagerMenu['ei_delivery']=(isset($ei_delivery)?$ei_delivery:null) ?>
                    <?php $pagerMenu['kal_function']=(isset($kal_function)?$kal_function:null) ?>
